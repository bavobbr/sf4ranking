...
public enum CharacterType
{
    ...
    DBFZ_ANDROID_17("ANDROID #17", "Android 17", Version.DBFZ),
    ...
    BBTAG_MIKA("MIKA", "Mika", Version.BBTAG),
    BBTAG_BLAKE("BLAKE", "Blake", Version.BBTAG),
    BBTAG_MAKOTO("MAKOTO", "Makoto", Version.BBTAG),
    BBTAG_WEISS("WEISS", "Weiss", Version.BBTAG),
    BBTAG_JIN("JIN", "Jin", Version.BBTAG),
    BBTAG_AZRAEL("AZRAEL", "Azrael", Version.BBTAG),
    BBTAG_WALDSTEIN("WALDSTEIN", "Waldstein", Version.BBTAG),
    BBTAG_HAZAMA("HAZAMA", "Hazama", Version.BBTAG),
    BBTAG_ES("ES", "Es", Version.BBTAG),
    BBTAG_LABRYS("LABRYS", "Labrys", Version.BBTAG),
    BBTAG_NINE("NINE", "Nine", Version.BBTAG),
    BBTAG_TAGER("TAGER", "Tager", Version.BBTAG),
    BBTAG_AEGIS("AEGIS", "Aegis", Version.BBTAG),
    BBTAG_IZAYOI("IZAYOI", "Izayoi", Version.BBTAG),
    BBTAG_MERKAVA("MERKAVA", "Merkava", Version.BBTAG),
    BBTAG_AKIHIKO("AKIHIKO", "Akihiko", Version.BBTAG),
    BBTAG_LINNE("LINNE", "Linne", Version.BBTAG),
    BBTAG_YUKIKO("YUKIKO", "Yukiko", Version.BBTAG),
    BBTAG_GORDEAU("GORDEAU", "Gordeau", Version.BBTAG),
    BBTAG_PLATINUM("PLATINUM", "Platinum", Version.BBTAG),
    BBTAG_YOSUKE("YOSUKE", "Yosuke", Version.BBTAG),
    BBTAG_YANG("YANG", "Yang", Version.BBTAG),
    BBTAG_MITSURI("MITSURU", "Mitsuru", Version.BBTAG),
    BBTAG_HAKUMEN("HAKUMEN", "Hakumen", Version.BBTAG),
    BBTAG_VATISTA("VATISTA", "Vatista", Version.BBTAG),
    BBTAG_NO13("NU13", "No13", Version.BBTAG),
    BBTAG_HYDE("HYDE", "Hyde", Version.BBTAG),
    BBTAG_NOEL("NOEL", "Noel", Version.BBTAG),
    BBTAG_YU("YU", "Yu", Version.BBTAG),
    BBTAG_RACHEL("RACHEL", "Rachel", Version.BBTAG),
    BBTAG_ORIE("ORIE", "Orie", Version.BBTAG),
    BBTAG_CARMINE("CARMINE", "Carmine", Version.BBTAG),
    BBTAG_MAI("MAI", "Mai", Version.BBTAG),
    BBTAG_YUZURIHA("YUZURIHA", "Yuzuriha", Version.BBTAG),
