...
class ScoringSystem
{
    ...
    public static Integer getDecayedScore(Date date, Integer rank, TournamentType tournamentType, TournamentFormat tournamentFormat = TournamentFormat.DOUBLE_BRACKET)
    {
        ...
        switch (monthsAgo) {
            ...
            case { monthsAgo > 22 }: decayFactor = 0.96; break
            case { monthsAgo > 21 }: decayFactor = 0.95; break
            case { monthsAgo > 20 }: decayFactor = 0.92; break
            case { monthsAgo > 19 }: decayFactor = 0.9; break
            case { monthsAgo > 18 }: decayFactor = 0.8; break
            case { monthsAgo > 17 }: decayFactor = 0.7; break
            case { monthsAgo > 16 }: decayFactor = 0.65; break
            case { monthsAgo > 15 }: decayFactor = 0.6; break
            case { monthsAgo > 14 }: decayFactor = 0.55; break
            case { monthsAgo > 13 }: decayFactor = 0.5; break
            case { monthsAgo > 12 }: decayFactor = 0.45; break
            case { monthsAgo > 11 }: decayFactor = 0.4; break
            case { monthsAgo > 10 }: decayFactor = 0.35; break
            case { monthsAgo > 9 }: decayFactor = 0.3; break
            case { monthsAgo > 8 }: decayFactor = 0.25; break
            case { monthsAgo > 7 }: decayFactor = 0.20; break
            case { monthsAgo > 6 }: decayFactor = 0.15; break
            case { monthsAgo > 5 }: decayFactor = 0.10; break
            case { monthsAgo > 4 }: decayFactor = 0.08; break
            case { monthsAgo > 3 }: decayFactor = 0.05; break
            case { monthsAgo > 2 }: decayFactor = 0.02; break
            case { monthsAgo > 1 }: decayFactor = 0.0; break
        }
