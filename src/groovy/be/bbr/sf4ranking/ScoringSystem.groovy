...
class ScoringSystem
{
    ...
    private static final Map ranks = [
            ...
            DOUBLE_BRACKET: [1, 2, 3, 4, [5] * 2, [7] * 2, [9] * 4, [13] * 4, [17] * 8, [25] * 8, [33] * 16, [49] * 16, [65] * 32, [97] * 32, [129] * 64, [193] * 64].flatten()
    ]
    ...
    public static Integer getDecayedScore(Date date, Date end, Integer rank, TournamentType tournamentType, TournamentFormat tournamentFormat = TournamentFormat.DOUBLE_BRACKET)
    {
        ...
        switch (monthsAgo) {
            ...
            case { monthsAgo > 22 }: decayFactor = 0.97; break
            case { monthsAgo > 21 }: decayFactor = 0.96; break
            case { monthsAgo > 20 }: decayFactor = 0.95; break
            case { monthsAgo > 19 }: decayFactor = 0.92; break
            case { monthsAgo > 18 }: decayFactor = 0.90; break
            case { monthsAgo > 17 }: decayFactor = 0.85; break
            case { monthsAgo > 16 }: decayFactor = 0.80; break
            case { monthsAgo > 15 }: decayFactor = 0.75; break
            case { monthsAgo > 14 }: decayFactor = 0.70; break
            case { monthsAgo > 13 }: decayFactor = 0.65; break
            case { monthsAgo > 12 }: decayFactor = 0.60; break
            case { monthsAgo > 11 }: decayFactor = 0.55; break
            case { monthsAgo > 10 }: decayFactor = 0.50; break
            case { monthsAgo > 9 }: decayFactor = 0.45; break
            case { monthsAgo > 8 }: decayFactor = 0.30; break
            case { monthsAgo > 7 }: decayFactor = 0.35; break
            case { monthsAgo > 6 }: decayFactor = 0.30; break
            case { monthsAgo > 5 }: decayFactor = 0.25; break
            case { monthsAgo > 4 }: decayFactor = 0.20; break
            case { monthsAgo > 3 }: decayFactor = 0.15; break
            case { monthsAgo > 2 }: decayFactor = 0.10; break
            case { monthsAgo > 1 }: decayFactor = 0.05; break
        }
