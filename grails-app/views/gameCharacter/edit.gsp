...
<html>
	...
	<body>
		<a href="#edit-gameCharacter" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-gameCharacter" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:gameCharacterInstance, action:'update']" method="PUT" >
