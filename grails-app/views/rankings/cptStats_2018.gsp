...
<div class="sb-site-container">
    <div class="boxed">
        ...
        <header class="main-header">
            <div class="container">
                <h1 class="page-title">Capcom Pro Tour 2018 Stats</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <h3 class="tournament"><small>72 Tournaments played</small></h3>
                    <div class="table-responsive">
                        ...
                        A total of <strong>20850 points </strong>could be scored.
