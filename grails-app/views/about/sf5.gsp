...
<g:img dir="images" file="ps4_starwars.png" class="charimg" width="450" height="180"/>
<g:img dir="images" file="ps4_uncharted.png" class="charimg" width="450" height="180"/>
...
<div class="table-responsive">
    <table class="table table-striped table-hover table-condensed">
        ...
        <tr>
            ...
            <td><a href="http://amzn.to/1Q6KuOD">Buy in US for $199.99</a></td>
            <td>UK Store</td>
            <td>FR Store</td>
            <td>DE Store</td>
            <td>ES Store</td>
        ...
        <tr>
            ...
            <td>Stick for PS3 and PS4</td>
            <td><a href="http://amzn.to/1OF7uDc">Buy in US for $229.99</a></td>
            <td>UK Store</td>
            <td>FR Store</td>
            <td>DE Store</td>
            <td>ES Store</td>
        ...
        <tr>
            <td>Mad Catz Arcade Fight Stick TE2</td>
            <td>Stick for PS3 and PS4, old-style</td>
...
<div class="table-responsive">
    <table class="table table-striped table-hover table-condensed">
        ...
        <tr>
            ...
            <td><a href="http://amzn.to/1OF7Ae2">Buy in US for $79.99</a></td>
            <td>UK Store</td>
            <td>FR Store</td>
            <td>DE Store</td>
            <td>ES Store</td>
        ...
        <tr>
            ...
            <td><a href="http://amzn.to/1R0SXmQ">Buy in US for $39.99</a></td>
