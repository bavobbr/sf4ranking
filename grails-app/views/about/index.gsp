...
<div class="jumbotron">
  <h1>Summary</h1>
  <p>
    The ranking given to players is analog to <a href="http://www.atpworldtour.com/">ATP and WTA</a>. Players earn points by placing in tournaments.
...
<blockquote>
  ...
  <br/>Upon its release, the game received universal critical acclaim; receiving universally high scores from many gaming websites and magazines. <a href="http://en.wikipedia.org/wiki/Street_fighter_4">Street Fighter 4 at Wikipedia</a>
</blockquote>
...
The tournament ranking is done by sorting on weight and then ditributing them into the tournament types used by <a href="http://en.wikipedia.org/wiki/Women%27s_Tennis_Association">WTA</a>
...
Glad you ask! This is a <a href="http://grails.org/">Grails</a> application, using GORM on MySQL for persistence, Grails services and controller for business logic and GSP for data rendering. The GSP pages are HTML5 using <a href="http://getbootstrap.com/">Bootstrap</a> for layout and JQuery for Javascript magic. All this is deployed on CloudBees on a Tomcat server. I love it.
</body>
</html>