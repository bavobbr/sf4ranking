...
<div class="row">
    <div class="col-md-6">
        <table class="tablehead" id="datatable">
            ...
            <tr>
            <td>Vendor</td>
            <td><g:link url="${controller.website}" target="_blank">${controller.website}</g:link></td>
                </tr>
            <tr>
            <td>Details</td>
            ...
            <td>
                <g:each in="${controller.players}" var="player">
                    <g:link controller="rankings" action="player" params="[id: player.id]">${player.name}</g:link>
                </g:each>
            </td>
            </tr>
            </tbody>
